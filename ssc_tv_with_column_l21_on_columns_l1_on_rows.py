"""SSC-TV-L21-P: L1 on E, L2,1 on P = DC, L1 on Q = CD^T.
...
def ssc_admm_nuc_tv(
    ...
    gamma    : float            TV weight  γ(||P||_{2,1} + ||Q||_1)
    ...
    for it in range(max_iter):
        ...
        # 3-4. P- and Q-updates: L2,1 on P (columns), L1 on Q (entries)
        DC  = D @ C
        CDt = C @ D.T
...
def ssc_admm_nuc_tv_e21(
    ...
    (rather than entry-level) corruption. TV uses L2,1 on P and L1 on Q.
