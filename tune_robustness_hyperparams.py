...
def main():
    ...
    tune_names = [m for m in args.methods if m in tuner.SEARCH_SPACES]
    skip_names = [m for m in args.methods if m not in tuner.SEARCH_SPACES]
    if skip_names:
        print(
    ...
    protocol_extra = {
        ...
        "prior_weight": args.prior_weight,
        "search_spaces": {m: tuner.SEARCH_SPACES[m] for m in tune_names},
